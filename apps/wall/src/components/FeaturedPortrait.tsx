...
import { DrawnPortrait } from './DrawnPortrait';

export function FeaturedPortrait({ portrait }: { portrait: WallFeedPortraitDto }) {
  return (
    // key forces a remount (and therefore replays the draw animation) whenever a new
    // portrait becomes the featured one.
    <div key={portrait.portraitId} className="relative w-[560px] shrink-0">
